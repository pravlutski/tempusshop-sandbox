...
system("/usr/bin/php81 -f /var/www/bitrix/data/www/tempusshop.ru/local/cron/parser/catalog_onliner.php >/dev/null 2>&1 &");// >/dev/null 2>&1 &");
...
if($csv->error != "no_found"){
	...
	//prent($arCsv);die;
	if(is_array($arCsv) && count($arCsv) > 0){
