...
if(CModule::IncludeModule("panel.manager")){
	...
	<div style="margin: 10px 0 0 0;">
		...
		<div class="col-lg-12 row">
			...
			<button class="btn btn-danger btn-courier-delete" style="margin: 10px 0 0 5px;" data-id="<?=$arResult["id"]?>" onclick="confirmCourierDelete(this);return false;">Удалить</button>
		</div>
	</div>
	<?else:?>
