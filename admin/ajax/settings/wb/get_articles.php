...
system("/usr/bin/php81 -f /var/www/bitrix/data/www/tempusshop.ru/local/cron/marketplace/wb/get_articles.php cabinet=".$cabinet." >>/userscripts/logs/get_articles.txt >/dev/null 2>&1 &");
