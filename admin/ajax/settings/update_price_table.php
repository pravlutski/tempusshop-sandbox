...
/*exec("pgrep -f /userscripts/update_price_table.php",$output,$code); 
if(is_array($output) && count($output) > 0){
	foreach($output as $pid)
		exec("kill -9 {$pid}");
}*/
	
system("/usr/bin/php81 -f /var/www/bitrix/data/www/tempusshop.ru/local/cron/catalog/update_price_table.php >/dev/null 2>&1 &");
// 
$res = array(
	'text' => ("asd")
);
