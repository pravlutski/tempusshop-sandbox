...
<body>
  <h2 class="util-name">Формирование заказа (для Олега)</h2>
  <a href="/admin/utilities/adapter2/" class="btn btn-warning" style="margin-bottom: 15px;">Для Дарьи</a>
...
$(document).on('click','.send-data-btn',function(){
  ...
  $.ajax({
    url: '/admin/utilities/adapter3/ajax/revModifier.php',
    method: 'POST',
    data: form_data,
    dataType: 'json',
    cache: false,
