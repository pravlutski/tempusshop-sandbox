...
$arSelect = Array("ID", "NAME", "IBLOCK_ID", "PROPERTY_123", "PROPERTY_AVAILABILITY_BY", "CATALOG_PRICE_2", "PROPERTY_CML2_ARTICLE", "PROPERTY_FINALCOUNTRY");
$arFilter = Array(
                ...
                <?foreach ($arProduct as $key => $item):?>
                    <div class="col-sm-4 main">
                        ...
                        <div class="third">
                            <div class="third-1">
                                <div class="background"><img src="/bitrix/components/adm/offline.pricelist/templates/.default/img/background.png"></div>
                                <span style="font-weight: 500;text-decoration: line-through;"><?=$item['PRICE']?>,00</span><span><?=$item['NEW_PRICE']?>,00</span>
                            </div>
                            <div class="third-2">
                                б.руб.<br>
                                шт.
