...
<?
?>
<form id="product_settings" action="/admin/modules/ozon/ajax/save_products.php" method="post">
<div class="card">
  <div class="card-body">
    <div style="display:flex;justify-content: space-between;">
    <p class="card-text"><b>Выбранные категории: </b>
  ...
  <ul class="list-group" style="padding: 20px !important;gap: 20px;">
  ...
  <div class="modal fade show" id="pop<?=$value['attribute_id']?>" tabindex="-1" aria-labelledby="exampleModalCenteredScrollableTitle" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <form class="modal-form" data-pop-id="pop<?=$value['attribute_id']?>" method="post" action="/admin/modules/ozon/ajax/save_directory_values.php">
  ...
  $('.att_set_value').each(function() {
    ...
    $(this).autocomplete({
      source: function(request, response) {
        $.ajax({
          method: 'GET',
          url: '/admin/modules/ozon/ajax/get_directory_values.php',
          dataType: 'json',
