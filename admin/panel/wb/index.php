...
$CurDB = new DBPanel();
$result = $CurDB->query("SELECT * FROM wb_agents");
...
$(document).ready(function() {
    function attachEventHandlers() {
        $('#table-panel').on('click', '.kill-script', function() {
            ...
            $.ajax({
                url: '/admin/panel/wb/ajax/tech/proc_kill.php',
                method: 'POST',
                data: {
                    script: dataScript,
                    code: dataCode,
        ...
        $('#table-panel').on('click', '.run-script', function() {
            ...
            var dataName = $(this).data('name');
            $.ajax({
                url: '/admin/panel/wb/ajax/tech/proc_run.php',
                method: 'POST',
                data: {
                    script: dataScript,
                    code: dataCode,
        ...
        $('#table-panel').on('click', '.reboot-script', function() {
            ...
            var dataName = $(this).data('name');
            $.ajax({
                url: '/admin/panel/wb/ajax/tech/proc_reboot.php',
                method: 'POST',
                data: {
                    script: dataScript,
                    code: dataCode,
    ...
    function updatePanel() {
        $.ajax({
            url: '/admin/panel/wb/ajax/tech/update_panel.php',
            method: 'GET',
            success: function(response) {
