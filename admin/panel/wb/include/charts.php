<script src="lib/chart.js" type="text/javascript"></script>
 <div class="charts-container" style="display:block">
    <div class="tabs-charts-control">
      ...
      <button id="c-tab-TL" class="c-tab t-selected btn btn-light">Кабинет IP</button>
    </div>
    <hr>
   <div class="block-TL chart-block" style="display:none">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-12">
          <i style="text-align: right;display:block; font-size: 14px; opacity:0.5"><?print_r( 'Последнее обновление было ' . date('Y.m.d G:i:s', filectime('/home/bitrix/ext_www/tempusshop.ru/admin/panel/engine/wb/logs/stat/TL/log.txt')) );?></i>
   ...
   <div class="block-WR chart-block" style="">
      <div class="row" style="">
        ...
        <div class="col-md-6 col-sm-12">
          <i style="text-align: right;display:block; font-size: 14px; opacity:0.5"><?print_r( 'Последнее обновление было ' . date('Y.m.d G:i:s', filectime('/home/bitrix/ext_www/tempusshop.ru/admin/panel/engine/wb/logs/stat/WR/log.txt')) );?></i>
