...
@media (max-width: 867px){
  ...
  html body header.navbar.navbar-dark.sticky-top.bg-dark.flex-md-nowrap.p-0.shadow.wb-color div.navbar-nav div.nav-item.text-nowrap a.nav-link.px-3.nav-top-link{
    display: none;
  }
}
</style>
