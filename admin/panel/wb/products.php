...
<div id="container-p" class="">
  <div class="tabs" style="display:flex; flex-direction:row; border-bottom: 1px solid #dbdcdc">
    <button id="main-set" value="main-block" class="tab t-selected">Базовые</button>
    <button id="match-set" value="match-block" class="tab">Атрибуты</button>
    <button id="dep-set" value="dep-block" class="tab">Зависимости</button>
    <button id="brand-set" value="brand-block" class="tab">Бренды</button>
    <button id="link-set" value="link-block" class="tab">Склейки</button>
    <button id="upload-set" value="upload-block" class="tab" style="display:none">Выгрузка</button>
    <button id="help-set" value="help-block" class="tab" style="">Справка</button>
  </div>
  <select class="mob-tabs btn btn-warning" style="display:none">
    <option value="main-block">Базовые</option>
    <option value="match-block" selected>Атрибуты</option>
    <!-- <option value="dep-block">Зависимости</option> -->
  </select>
  <div id="match-block" class="tab-block" style="display:none;">
  ...
  <div id="main-block" class="tab-block" style="">
    <div style="display:flex; flex-direction:row">
      <div style="width: fit-content; margin-top:15px; margin-left:15px">
        <a id="topModels_WB" class="btn btn-primary"/>Топ ВБ</a>
      </div>
  ...
  <? require('include/products/upload_block.php');?>
  <? require('include/products/help_block.php');?>
  <? require('include/products/brand_block.php');?>
  <? require('include/products/link_block.php');?>

</div>
<?require('include/mobile.php');?>
<?require('include/products/top_modal.php');?>
<style media="screen">
  .ui-front {
...
<script type="text/javascript">
  ...
  $(document).on('change', '.mob-tabs', function(e){
    e.preventDefault();
    $('.tab-block').hide();
    $( '#' + $(this).val() ).show();
  })
