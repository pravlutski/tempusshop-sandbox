...
$logPathMain = $_SERVER["DOCUMENT_ROOT"] . "/admin/panel/engine/wb/logs/orders/{$cabinet}/{$_POST['date']}_orders.txt";
$logPathStatus = $_SERVER["DOCUMENT_ROOT"] . "/admin/panel/engine/wb/logs/orders/{$cabinet}/{$_POST['date']}_order_update.txt";
