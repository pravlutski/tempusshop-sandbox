...
$tmp = file_get_contents('/var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport2/logs/stocks/shows/'.$curdate.'.txt');
$arTmp = explode('#SPLIT#',$tmp);
foreach ($arTmp as $key => $value) {
  $arSoloLog = json_decode($value,true);
  if($arSoloLog['UPDATE']['GOOD']){
...
$tmpSales = file_get_contents('/var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport2/logs/sales/log.txt');
...
<div class="card">
  ...
  <div class="card-body">
    <a href="/admin/modules/ozon2/logs/price.php?price=<?=date('Y-m-d')?>" style="width: 100%;" class="btn btn-success" disabled>Лог цен</a>
    <a href="/admin/modules/ozon2/logs/stock.php?stock=<?=date('Y-m-d')?>" style="width: 100%;" class="btn btn-success" disabled>Лог остатков</a>
    <a href="/admin/modules/ozon2/logs/fbo.php" style="width: 100%;" class="btn btn-success" disabled>Лог проверки ФБО</a>
  </div>
</div>
</div>
<?//скидки?>
<div class="col-md-4 col-sm-12">
  <div class="card">
    ...
    <div class="card-body">
      <a href="/admin/modules/OzonImport2/importSalesGroup.php" target="_blank" style="width: 100%;" type="submit" class="btn btn-warning">Перевыгрузить акции</a>
    </div>
    <ul class="list-group list-group-flush">
      <li class="list-group-item" id="status_sales">
        <b style="text-decoration: underline;font-size: 20px;">Акции:</b><br>
          <b>Последнее обновление в </b><?=date('G:i:s', filectime('/var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport2/logs/sales/log.txt'))?><br>
    ...
    <div class="card-body">
      <a href="/admin/modules/ozon2/sales/log.php" style="width: 100%;" class="btn btn-success">Лог акций</a>
    </div>
  </div>
</div>
  <?//товары?>
  <div class="col-md-4 col-sm-12">
    <div class="card">
      ...
      <div class="card-body">
        <a href="/admin/modules/ozon2/logs/product.php" style="width: 100%;" class="btn btn-success">Лог товаров</a>
      </div>
    </div>
  </div>
