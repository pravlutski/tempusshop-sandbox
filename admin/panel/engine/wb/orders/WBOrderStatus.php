...
$workerMap = array(
	"WR" => "engine_wb_orders_WBOrderStatus_php_WR",
	"WT" => "engine_wb_orders_WBOrderStatus_php_WT",
	"TL" => "engine_wb_orders_WBOrderStatus_php_TL",
);
$workerId = isset($workerMap[$workerKey]) ? $workerMap[$workerKey] : "engine_wb_orders_WBOrderStatus_php_WR";
