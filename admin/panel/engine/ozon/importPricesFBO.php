...
class OzonImportPricesFBO{
    ...
    $this->token = $arSetting['key'];
		...
		//Агент-Инфо
		$this->updateStatus($this->module, ['status_text' => 'Получаем данные для выгрузки цен', 'percent' => 60]);
	...
	public function run(){
		...
		//Агент-Инфо
		$this->updateStatus($this->module, ['status_text' => 'Подготовка массива для выгрузки цен', 'percent' => 70]);
    ...
    $this->BuildArray();
		...
		//Агент-Инфо
		$this->updateStatus($this->module, ['status_text' => 'Выгружаем цены', 'percent' => 80]);
