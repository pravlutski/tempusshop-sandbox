...
class OzonOrderStatus
{
    ...
    public function __construct()
    {
      ...
      $res = $this->dbPanel->select(['*'], "ozon_main_settings_IP")->make();
      foreach ( $res as $row ){
      ...
      $this->options = [
        ...
        'log_path' => '/var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport2/logs/orders/' . date('Y-m-d') . '_order_update.txt'
      ];
    }
