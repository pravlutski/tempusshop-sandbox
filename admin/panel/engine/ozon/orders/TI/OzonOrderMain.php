...
class OzonOrderMain {
  ...
  public function __construct()
  {
      ...
      $this->options = [
        ...
        'log_path' => '/var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport2/logs/orders/' . date('Y-m-d') . '_orders.txt'
      ];
