...
$logPathMain = "/var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport/logs/orders/{$_POST['date']}_orders.txt";
$logPathStatus = "/var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport/logs/orders/{$_POST['date']}_order_update.txt";
