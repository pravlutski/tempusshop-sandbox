...
system("/usr/bin/php -f /var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport/importProducts.php > /dev/null 2>&1 &");
}
...
if ($_POST['request'] == 'kill') {
  ...
  if(is_array($output) && count($output) > 0){
    ...
    $DB->Update("wdhs_ozon_upload_status", array("status" => "'COMPLETE'","percent" => "'100'"), "WHERE agent = 'products'", $err_mess.__LINE__);
  }
}
