...
class OzonPostingsPH
{
  ...
  function __construct()
  {
    ...
    $this->token = $arSetting['key'];
		$this->logPath = '/var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport2/logs/stat/postingsPH.txt';
  ...
  private function getPostingsFBS()
  {
      ...
      foreach ( $result['result']['postings'] as $posting ){
        foreach ($posting['products'] as $product) {
          if( $posting['delivery_method']['warehouse_id'] == 1020001970733000){
  ...
  private function countShares()
  {
    ...
    file_put_contents('/var/www/bitrix/data/www/tempusshop.ru/admin/modules/ozon2/stat/perHour.json', json_encode($this->shares));
  }
}
