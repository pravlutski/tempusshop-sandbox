...
class OzonPostingsPH
{
  ...
  function __construct()
  {
    ...
    $this->token = $arSetting['key'];
		$this->logPath = '/var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport2/logs/stat/postingsPD.txt';
  ...
  private function writeDB()
  {
    ...
    $this->fuckYouBitrixORM('ozon_postings_shares_ti', $data);
