...
<?
?>
<form id="pi_settings" action="/admin/modules/ozon2/sales/ajax/save_pi.php" method="post">
  <div class="card">
    <div class="card-body">
...
<form id="sales_settings" action="/admin/modules/ozon2/sales/ajax/save_sales.php" method="post">
  <div class="card">
    <div class="card-body">
...
$(document).ready(function() {
  ...
  $('#saveTopModels').click(function() {
    ...
    $.ajax({
      url: '/admin/modules/ozon2/sales/ajax/save_pi.php',
      method: 'POST',
