...
<form id="main_settings" action="/admin/modules/ozon2/ajax/save_settings.php" method="post">
  ...
  <h3>Настройки ФБО</h3>
  <div class="input-group mb-3">
    <span class="input-group-text" id="basic-addon3" style="width: 200px;">Комиссия OZON</span>
    <input required type="text" class="form-control" name="com" id="basic-url" aria-describedby="basic-addon3" value="<?=$arResult['com']?>">
  </div>
  <div class="input-group mb-3">
    <span class="input-group-text" id="basic-addon3" style="width: 200px;">Комиссия ФБО</span>
    <input required type="text" class="form-control" name="newCom" id="basic-url" aria-describedby="basic-addon3" value="<?=$arResult['newCom']?>">
  </div>
	<div class="card">
  <div class="card-body">
...
<div class="col-md-4 col-sm-12">
	<div class="alert alert-success alert-dismissible fade show helper" role="alert" >
  	<div>
