...
class OzonOrderStatus
{
    ...
    public function __construct()
    {
      ...
      $this->api = [
        ...
        'client_id' => '211514',
        'key' => '00bdecf1-32c2-4b74-aec9-73bee4ff4b4e'
      ];
      $this->options = [
        ...
        'log_path' => '/var/www/bitrix/data/www/tempusshop.ru/admin/modules/OzonImport2/logs/ordersKZ/' . date('Y-m-d') . '_order_update.txt'
      ];
    }
