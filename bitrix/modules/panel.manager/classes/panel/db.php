...
class DBPanel {
    ...
    public function select( array $select, string $table ):DBPanel
    {
    ...
    public function where( string $column, string|int|float|array $value, string $operator = '=' ):DBPanel
    {
      return $this->whereBase($column, $value, $operator, 'AND');
    }

    public function orWhere( string $column, string|int|float|array $value, string $operator = '=' ):DBPanel
    {
      return $this->whereBase($column, $value, $operator, 'OR');
    }

    public function whereNot( string $column, string|int|float|array $value, string $operator = '=' ):DBPanel
    {
      return $this->whereBase($column, $value, $operator, 'AND', 'NOT');
    }

    public function orWhereNot( string $column, string|int|float|array $value, string $operator = '=' ):DBPanel
    {
      return $this->whereBase($column, $value, $operator, 'OR', 'NOT');
    }

    private function whereBase( string $column, string|int|float|array $value, string $operator = '=', string $merge = "AND", string $opposite = '' ):DBPanel
    {
    ...
    public function desc( string $column ):DBPanel
    {
      return $this->orderBase($column, 'DESC');
    }

    public function asc( string $column ):DBPanel
    {
      return $this->orderBase($column, 'asc');
    }

    private function orderBase( string $column, string $sort ):DBPanel
    {
    ...
    public function limit( int $limit ):DBPanel
    {
      if ( empty( $limit ) ){
        trigger_error( "One of the parameters is empty. Method: orderBy", E_USER_ERROR );
      }
    ...
    public function group( string $group ):DBPanel
    {
      if ( empty( $group ) ){
