...
//$arFilter['ID'] = 174809;
	...
	public function createInfoGrahp(){
        ...
        //if ((time() - 1 * 24 * 60 * 60) < $dateM) {
          ...
          $r0_main = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_main_detail_resize-'.$id.'.jpg';
          unlink($r0_main);
            ...
            CFile::ResizeImageFile(
               ...
               false
					...
					if ($checkWidth < 685) {
						...
						$r0_main_r = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_main_detail_resize-'.$id.'.jpg';
					...
					if ($checkheight < 930) {
						...
						$r0_main_r = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_main_detail_resize-hehight-'.$id.'.jpg';
						// Выводим изображение или сохраняем в файл
						imagejpeg($newImage, $r0_main_r);
          ...
          $r0_top_left = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_main_top_left-'.$id.'.jpg';
          // Выводим изображение или сохраняем в файл
          ...
          $r0_bot_right = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_main_bot_right-'.$id.'.jpg';
          // Выводим изображение или сохраняем в файл
          ...
          if (!empty($arItem['BRAND_ID'])) {
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_res_brand-'.$id.'.jpg';
          ...
          if (!empty($arItem['MECHANISM']) and isset($resized)) {
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_res_mech-'.$id.'.jpg';
            $newW = $srcWidth; $newH = $srcHeight;
            CFile::ResizeImageFile(
               $resized,
               $tempFile,
          ...
          if (!empty($arItem['WARRANTY']) and isset($resized)) {
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_res_war-'.$id.'.jpg';
            $newW = $srcWidth; $newH = $srcHeight;
            CFile::ResizeImageFile(
               $resized,
               $tempFile,
          ...
          if (!empty($arItem['GLASS']) and isset($resized)) {
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_res_glass-'.$id.'.jpg';
            $newW = $srcWidth; $newH = $srcHeight;
            CFile::ResizeImageFile(
               $resized,
               $tempFile,
          ...
          if (!empty($arItem['WR']) and isset($resized)) {
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_res_wr-'.$id.'.jpg';
            $newW = $srcWidth; $newH = $srcHeight;
            CFile::ResizeImageFile(
               $resized,
               $tempFile,
          ...
          if (isset($resized)) {
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/ozon_RESULT-'.$id.'.jpg';
            $newW = $srcWidth; $newH = $srcHeight;
            CFile::ResizeImageFile(
               $resized,
               $tempFile,
