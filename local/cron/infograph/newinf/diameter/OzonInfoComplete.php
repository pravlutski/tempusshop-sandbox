...
class InfoGraph{
    ...
    file_put_contents("/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/logs/ozon/log.txt", print_r('START '.date('Y-m-d H:i:s'), true).PHP_EOL);
