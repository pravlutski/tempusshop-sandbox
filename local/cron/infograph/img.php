	...
	public function createInfoGrahp(){
        ...
        if ((time() - 1 * 24 * 60 * 60) < $dateM) {
          ...
          if ($originalWidthD > 653 and $originalWidthD == $originalHeightD) {
            ...
            CFile::ResizeImageFile(
               ...
               false
					...
					$srcImage = imagecreatefromjpeg($r0_main);
          ...
          if (!empty($arItem['BRAND_ID'])) {
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/res_brand-'.$id.'.jpg';
          ...
          if (!empty($arItem['MECHANISM']) and isset($resized)) {
            switch ($arItem['MECHANISM']) {
              case 'Кварцевые':
                $mechWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/mecha/qartz.png';
                break;
              case 'Механические':
                $mechWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/mecha/mehanicheskie.png';
                break;
              case 'Автоматические с ручным подзаводом':
                $mechWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/mecha/automatic_podzavod.png';
                break;
              case 'Автоматические':
                $mechWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/mecha/automatic.png';
                break;
              case 'Автокварц (кинетик)':
                $mechWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/mecha/autoqartz.png';
                break;
              case 'Процессор':
                $mechWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/mecha/processor.png';
                break;
              default:
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/res_mech-'.$id.'.jpg';
            $newW = $srcWidth; $newH = $srcHeight;
            CFile::ResizeImageFile(
               $resized,
               $tempFile,
          ...
          if (!empty($arItem['WARRANTY']) and isset($resized)) {
            switch ($arItem['WARRANTY']) {
              case '1 год':
                $warWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/garantiya/garantiya_1_god.png';
                break;
              case '1 года':
                $warWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/garantiya/garantiya_1_god.png';
                break;
              case '2 года':
                $warWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/garantiya/garantiya_2_goda.png';
                break;
              case '3 года':
                $warWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/garantiya/garantiya_3_goda.png';
                break;
              default:
                file_put_contents("/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/log.txt", print_r($arItem['ID'].' - Проблема со свойством WARRANTY', true).PHP_EOL, FILE_APPEND);
                break;
            }
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/res_war-'.$id.'.jpg';
            $newW = $srcWidth; $newH = $srcHeight;
            CFile::ResizeImageFile(
               $resized,
               $tempFile,
          ...
          if (!empty($arItem['GLASS']) and isset($resized)) {
            switch ($arItem['GLASS']) {
              case 'Минеральное':
                $glassWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/steklo/mineralnoe.png';
                break;
              case 'Органическое':
                $glassWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/steklo/organicheskoe.png';
                break;
              case 'Сапфировое':
                $glassWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/steklo/sapfirovoe.png';
                break;
              default:
                file_put_contents("/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/log.txt", print_r($arItem['ID'].' - Проблема со свойством GLASS', true).PHP_EOL, FILE_APPEND);
                break;
            }
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/res_glass-'.$id.'.jpg';
            $newW = $srcWidth; $newH = $srcHeight;
            CFile::ResizeImageFile(
               $resized,
               $tempFile,
          ...
          if (!empty($arItem['WR']) and isset($resized)) {
            switch ($arItem['WR']) {
              case 'WR30m':
                $wrWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/WR/WR30.png';
                break;
              case 'WR200m':
                $wrWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/WR/WR200.png';
                break;
              case 'WR1000m':
                $wrWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/WR/WR1000.png';
                break;
              case 'WR100m':
                $wrWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/WR/WR100.png';
                break;
              case 'WR600m':
                $wrWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/WR/WR600.png';
                break;
              case 'WR300m':
                $wrWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/WR/WR300.png';
                break;
              case 'WR50m':
                $wrWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/WR/WR50.png';
                break;
              case 'WR500m':
                $wrWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/WR/WR500.png';
                break;
              case 'WR180m':
                $wrWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/WR/WR180.png';
                break;
              case 'WR150m':
                $wrWater = '/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/wablon/WR/WR150.png';
                break;
              default:
                file_put_contents("/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/log.txt", print_r($arItem['ID'].' - Проблема со свойством WR', true).PHP_EOL, FILE_APPEND);
                break;
            }
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/res_wr-'.$id.'.jpg';
            $newW = $srcWidth; $newH = $srcHeight;
            CFile::ResizeImageFile(
               $resized,
               $tempFile,
          ...
          if (isset($resized)) {
            ...
            $tempFile = '/var/www/bitrix/data/www/tempusshop.ru/upload/testImg/test/RESULT-'.$id.'.jpg';
            $newW = $srcWidth; $newH = $srcHeight;
            CFile::ResizeImageFile(
               $resized,
               $tempFile,
        ...
        file_put_contents("/var/www/bitrix/data/www/tempusshop.ru/local/cron/infograph/log.txt", print_r($arItem['ID'].' - отсутсвует деатльное изображение', true).PHP_EOL, FILE_APPEND);
      }
		 unset($arItem);
		}
  }
