...
if(file_exists($localFile)){
	...
	echo "arCsv - " . count($arCsv) . "\r\n";
	echo "arWB - " . count($arWB) . "\r\n";
	echo "bxItems - " . count($bxItems) . "\r\n";
	echo "Обновили значения у - " . $update . " товаров из " . $i . "\r\n";
	
	CProSet::setOption("WB_UPDATE_CARDID", $update);
}else{
	$arLog = array(
		"event" => "E",
...
echo date("Y-m-d H:i:s") . " Обновили значения у - " . $update . " товаров";
?>