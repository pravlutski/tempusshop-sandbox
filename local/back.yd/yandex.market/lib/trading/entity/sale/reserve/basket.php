...
class Basket extends Skeleton
{
	...
	{
		$reserveCollectionClassName = $this->getReserveCollectionClassName();
		$found = [];
	...
	/**
	 * @return Sale\ReserveQuantityCollection
	 * @noinspection PhpIncompatibleReturnTypeInspection
	 */
	protected function getReserveCollectionClassName()
	{
		...
		return method_exists($registry, 'getReserveCollectionClassName')
			? $registry->getReserveCollectionClassName()
			: Sale\ReserveQuantityCollection::class;
	}
}