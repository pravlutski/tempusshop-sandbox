		...
		switch ($place)
		{
			...
			case 'epilog':
				$result = [
					...
					new Xml\Tag\Base([
						'name' => 'manual',
						'value_type' => Type\Manager::TYPE_FILE,
						'multiple' => true,
						'max_count' => 6,
						'attributes' => [
							new Xml\Attribute\Base(['name' => 'title', 'visible' => true]),
						],
					]),
					...
					new Xml\Tag\Base(['name' => 'custom_label_0']),
					new Xml\Tag\Base(['name' => 'custom_label_1']),
					new Xml\Tag\Base(['name' => 'custom_label_2']),
					new Xml\Tag\Base(['name' => 'custom_label_3']),
					new Xml\Tag\Base(['name' => 'custom_label_4']),
					new Xml\Tag\Base(['name' => 'custom_score', 'value_type' => Type\Manager::TYPE_NUMBER]),
					new Xml\Tag\Age([
						'attributes' => [
