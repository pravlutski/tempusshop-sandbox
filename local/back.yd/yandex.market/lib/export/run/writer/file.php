...
class File extends Base
{
	...
	protected function getFileResource()
	{
		if (!isset($this->fileResource))
		{
			...
			// file_put_contents("/var/www/bitrix/data/www/tempusshop.ru/bitrix/modules/yandex.market/lib/export/run/writer/log.txt", print_r('START'.date('Y-m-d H:i:s'), true).PHP_EOL, FILE_APPEND);
			// file_put_contents("/var/www/bitrix/data/www/tempusshop.ru/bitrix/modules/yandex.market/lib/export/run/writer/log.txt", print_r($this->filePath, true).PHP_EOL, FILE_APPEND);
