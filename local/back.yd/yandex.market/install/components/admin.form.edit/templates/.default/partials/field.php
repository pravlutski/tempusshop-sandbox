...
{
	?>
	<tr <?= Market\Ui\UserField\Helper\Attributes::stringify($additionPreviousAttributes) ?>>
...
{
	?>
	<tr <?= Market\Ui\UserField\Helper\Attributes::stringify($additionNextAttributes) ?>>
