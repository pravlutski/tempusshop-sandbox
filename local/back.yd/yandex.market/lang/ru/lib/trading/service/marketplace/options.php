...
$MESS['YANDEX_MARKET_TRADING_SERVICE_MARKETPLACE_OPTION_YANDEX_MODE'] = 'Способ работы';
$MESS['YANDEX_MARKET_TRADING_SERVICE_MARKETPLACE_OPTION_YANDEX_MODE_DESCRIPTION'] = 'Отметьте Получать запросы от Маркета на той же странице (Настройки &rarr; Настройки API, вкладка Получение запросов от Маркета), если ваш сайт готов стабильно отвечать.';
$MESS['YANDEX_MARKET_TRADING_SERVICE_MARKETPLACE_OPTION_YANDEX_MODE_PULL'] = 'Загружать заказы на агентах';
$MESS['YANDEX_MARKET_TRADING_SERVICE_MARKETPLACE_OPTION_YANDEX_MODE_PUSH'] = 'Получать запросы от Маркета';
