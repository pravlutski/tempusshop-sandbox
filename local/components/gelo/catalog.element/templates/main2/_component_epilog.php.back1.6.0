							...
							<?if($templateData['ASSOCIATED']):?>
								...
								<?if($bShowAssociatedTab):?>
									...
									<?endif;?>
										...
										<div class="tabs_slider assoc-block js-load-block loader_circle tabs_slider nav-data_block" data-block="assoc" data-file="<?=$APPLICATION->GetCurPage()?>">
											<div class="stub"></div>
							...
							<?if($templateData['EXPANDABLES']):?>
								...
								<?if($bShowExpandablesTab):?>
									...
									<?endif;?>
										...
										<div class="expandables-block js-load-block loader_circle tabs_slider nav-data_block" data-block="expandables" data-file="<?=$APPLICATION->GetCurPage()?>">
											<div class="stub"></div>
						...
						<?if($templateData['ASSOCIATED']):?>
							...
							<?if($bShowAssociatedTab):?>
								<div class="ordered-block <?=$code?> cur">
									...
									<div class="assoc-block js-load-block loader_circle tabs_slider nav-data_block" data-block="assoc" data-file="<?=$APPLICATION->GetCurPage()?>">
										<div class="stub"></div>
										<?$ajaxNavBlock = isset($_REQUEST['pagen_data_block']) && $_REQUEST['pagen_data_block'] == 'Y' && isset($_REQUEST['data_block']) && $_REQUEST['data_block'] == 'assoc';?>
										<?if($ajaxNavBlock){
											$APPLICATION->RestartBuffer();
