...
//$cachePath = "/" . SITE_ID . "/op/catalog.section/" . $arParams["SECTION_ID"];
$cachePath = "/" . SITE_ID . "/op/catalog.section/" . $arParams["SECTION_ID"] . "/" . $cacheId;
...
*/
	...
	if (!empty($arResult["ELEMENTS"]) && ($bGetProperties || ($bCatalog && $boolNeedCatalogCache)))
	{
		...
		CIBlockElement::GetPropertyValuesArray($arElementLink, $arParams["IBLOCK_ID"], $arPropFilter, array('CODE' => array('MORE_PHOTO')));
