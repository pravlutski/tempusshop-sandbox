<?
	...
	$MESS['SEO_TEXT_1'] = 'Часы ';
	$MESS['SEO_TEXT_2'] = 'Интернет-магазин TEMPUS предлагает купить оригинальные наручные часы. Прямые поставки от производителя, богатый выбор моделей различного класса и стиля, доступные цены, быстрая доставка по Беларуси.';
	$MESS['SEO_TEXT_3'] = ' купить в Минске. Каталог наручных оригинальных часов ';
	$MESS['SEO_TEXT_4'] = ' c доставкой по Беларуси';
	$MESS['SEO_TEXT_PAGE'] = 'страница';
	$MESS['SEO_TEXT_6'] = '';
	$MESS['SEO_TEXT_7'] = '';
?>